...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Tambah Jenjang Pendidikan</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Form Tambah Jenjang Pendidikan</h3>
                    </div>
                    <form action="{{ route('education-levels.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_jenjang') is-invalid @enderror" id="nama_jenjang" name="nama_jenjang" value="{{ old('nama_jenjang') }}" required>
                                @error('nama_jenjang')
